...
namespace MvcAppTest2.Controllers
{
    public class SpeakersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "SpeakerID,Name,EmailAdd,BirthDay")] Speaker speaker)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "SpeakerID,Name,EmailAdd,BirthDay")] Speaker speaker)
        {
            if (ModelState.IsValid)
            {
